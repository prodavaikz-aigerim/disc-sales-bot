...
def format_paid_offer_text() -> str:
    ...
    lines = [
        ...
        (
            "Сейчас ты знаешь только две части своего профиля: твой "
            "психотип — как ты проявляешь себя в продажах, и код мотивации "
            "— что тебя внутренне двигает. Но самое ценное начинается там, "
            "где эти два показателя соединяются."
        ),
        "",
