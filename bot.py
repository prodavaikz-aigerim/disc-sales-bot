...
MOTIVATOR_QUESTIONS = [
    {
        "text": "Мне важно разобраться, почему что-то работает именно так, прежде чем использовать это на практике.",
        "category": "T",
    },
    {
        "text": "Для меня важно, чтобы мои действия приносили конкретную пользу и отдачу.",
        "category": "U",
    },
    {
        "text": "Мне важно, чтобы результат моей работы был не только качественным, но и красивым.",
        "category": "A",
    },
    {
        "text": "Мне важно видеть, что благодаря моей работе жизнь или состояние другого человека действительно улучшается.",
        "category": "S",
    },
    {
        "text": "Мне нравится брать на себя ответственность за направление, в котором движется команда или проект.",
        "category": "I",
    },
    {
        "text": "Мне важно поступать в соответствии со своими принципами, даже если это не самый выгодный для меня вариант.",
        "category": "TR",
    },
    {
        "text": "Я получаю удовольствие от изучения нового, даже если эти знания не нужны мне прямо сейчас.",
        "category": "T",
    },
    {
        "text": "При выборе между несколькими вариантами я прежде всего оцениваю их практическую ценность.",
        "category": "U",
    },
    {
        "text": "Я тонко замечаю атмосферу, стиль, визуальные детали и то, насколько всё гармонично сочетается.",
        "category": "A",
    },
    {
        "text": "Я получаю глубокое удовлетворение, когда могу поддержать, помочь или облегчить жизнь другому человеку.",
        "category": "S",
    },
    {
        "text": "Мне важно иметь возможность влиять на решения и события, а не просто выполнять чужие указания.",
        "category": "I",
    },
    {
        "text": "В сложной ситуации я предпочитаю принять решение, которое считаю правильным, а не просто удобным.",
        "category": "TR",
    },
    {
        "text": "В разговоре меня больше интересуют идеи, закономерности и причины, чем бытовые детали.",
        "category": "T",
    },
    {
        "text": "Я быстро теряю интерес к задаче, если не вижу её практического смысла или результата.",
        "category": "U",
    },
    {
        "text": "Даже когда функциональность уже обеспечена, мне хочется довести внешний вид и подачу до совершенства.",
        "category": "A",
    },
    {
        "text": "При принятии решений я учитываю не только свои интересы, но и то, как они повлияют на других людей.",
        "category": "S",
    },
    {
        "text": "Я чувствую себя особенно уверенно, когда именно от моего решения зависит важный результат.",
        "category": "I",
    },
    {
        "text": "Мне важно, чтобы мои действия соответствовали моим глубоким убеждениям о том, что правильно и неправильно.",
        "category": "TR",
    },
    {
        "text": "Если я сталкиваюсь с новым утверждением, мне хочется проверить и понять, на чём оно основано.",
        "category": "T",
    },
    {
        "text": "Рост дохода, продаж, прибыли или других измеримых показателей заметно мотивирует меня.",
        "category": "U",
    },
    {
        "text": "Я предпочитаю гармоничную и эстетичную среду даже тогда, когда практической необходимости в этом нет.",
        "category": "A",
    },
    {
        "text": "Мне трудно заниматься тем, что приносит мне выгоду, но может причинять неоправданный вред другим.",
        "category": "S",
    },
    {
        "text": "Для меня важно достигать положения, с которого я могу влиять на людей и процессы.",
        "category": "I",
    },
    {
        "text": "Я могу отказаться от привлекательной возможности, если она противоречит моим принципам.",
        "category": "TR",
    },
]
...
async def start_motivators(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    intro_parts = [
        ...
        (
            ...
            "Оцени каждое по шкале от 1 до 5 — насколько это похоже на "
            "тебя.\n\n"
            "После нажатия на цифру придёт короткое уведомление «✅ Принято» "
            "— жди его перед следующим нажатием, чтобы не отвечать на "
            "вопросы дважды.\n\n"
